...
public class EjecutarEstudiante {
    public static void main(String[] args) {
        ...
        Estudiante objEst1 = new Estudiante(909876, "Santiago", "Caracas", "ingenieiria", "matematicas");
        Estudiante objEst2 = new Estudiante(909877, "Johana", "Bahoz", "ingenieiria", "fisica");
        Estudiante objEst3 = new Estudiante(909878, "Elizabeth", "Mina", "ingenieiria", "quimica");
        ...
        est[3] = new Estudiante(789654, "Valeria", "Cortez", "Licenciatura", "Ingles");
        est[4] = new Estudiante(789655, "Brandon", "Burbano", "Psicologia", "Manejo de Emociones");
